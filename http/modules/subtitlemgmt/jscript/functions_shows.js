    ...
    get_show.inline([
        ...
        function(callback) {
            ...
            $.ajax({
                ...
                error: function(data) {
                    ...
                    webtools.display_error('Failed fetching the size of the section from the server. Please restart the server.<br>'
                                  +'<br>Errorinfo:'
        ...
        function(callback) {
            ...
            $.ajax({
                ...
                error: function(data) {
                    webtools.display_error('Failed fetching the section contents from the server. Please restart the server.<br>'
                                  +'<br>Errorinfo:'
                                  +'<br>Requested URL: ' + this.url
                                  +'<br>Error Code/Message: ' + data.status + '/'  + data.statusText);
                    $('#LoadingModal').modal('hide');
    ...
    get_season.inline([
        ...
        function(callback) {
            ...
            $.ajax({
                ...
                error: function(data) {
                    webtools.display_error('Failed fetching the seasons from the server. Please restart the server.<br>'
                                  +'<br>Errorinfo:'
                                  +'<br>Requested URL: ' + this.url
                                  +'<br>Error Code/Message: ' + data.status + '/'  + data.statusText);;
                    $('#LoadingModal').modal('hide');
    ...
    get_episodes.inline([
        ...
        function(callback) {
            ...
            $.ajax({
                ...
                error: function(data) {
                    webtools.display_error('Failed fetching the episodes from the server. Please restart the server.<br>'
                                  +'<br>Errorinfo:'
                                  +'<br>Requested URL: ' + this.url
                                  +'<br>Error Code/Message: ' + data.status + '/'  + data.statusText);
                    $('#LoadingModal').modal('hide');
