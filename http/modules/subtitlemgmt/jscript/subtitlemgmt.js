...
webtools.functions.subtitlemgmt = {
    start: function () {this.loadmorejavascripts.start(); },
...
subtitlemgmt.loadmorejavascripts.completefunction = function() {
    ...
    $('#ContentBody').html('This is an unofficial manager for subtitles.<br><b>Usage is on your own risk!</b><br><br>Current features:<br><ul><li>List all subtitles for a movie/tv show in your library. Both local (next to the movie in it\'s folder or one subfolder) and in the agents folder.</li><li>View the subtitle and see it\'s contents to determine what to delete.</li><li>Delete selected sidecar from the harddrive.</li><li>Options for output.</li></ul>');    
...
subtitlemgmt.save_options = function() {
    ...
    ], function(result) {webtools.log(result);$('#OptionsModal').modal('hide');});
}
